...
using DrakeLambert.Peerra.WebApi2.IdentityCore.Interfaces.Infrastructure;
...
namespace DrakeLambert.Peerra.WebApi2.IdentityCore.Services
{
    public class UserTokenService : IUserTokenService
    {
        ...
        public UserTokenService(IIdentityUserRepository userRepository, IRefreshTokenRepository refreshTokenRepository, ITokenFactory tokenGenerator, ITokenValidator tokenValidator, IAppLogger<UserTokenService> logger)
        {
